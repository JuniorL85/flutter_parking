              ...
              child: Row(
                ...
                children: [
                  TextButton(
                    onPressed: () {
                      setState(() {
                        activeParkingsList.sort((a, b) =>
                            a.parkingSpace!.pricePerHour.toString().compareTo(
                                b.parkingSpace!.pricePerHour.toString()));
                      });
                    },
                  ...
                  TextButton(
                    onPressed: () {
                      setState(() {
                        activeParkingsList.sort((a, b) =>
                            b.parkingSpace!.pricePerHour.toString().compareTo(
                                a.parkingSpace!.pricePerHour.toString()));
                      });
                    },
